<?php
    ...
    clinics as c,
    receptionists as r
    WHERE app.appointmentsID = '".$appID."' AND app.dentistID = den.dentistID AND app.dentistID = den.dentistID AND p.patientID = app.patientID AND r.receptionistsID = app.receptionistID AND c.clinicID = app.clinicID;";
